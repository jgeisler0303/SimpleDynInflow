...
---------------------- INPUT FILES ---------------------------------------------
"coh_elastodyn.dat"             EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"coh_URef-12_inflowwind.dat"             InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"coh_aerodyn.dat"             AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"coh_servodyn.dat"             ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"unknown"     HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unknown"     SubFile         - Name of file containing sub-structural input parameters (quoted string)
"unknown"     MooringFile     - Name of file containing mooring system input parameters (quoted string)
"unknown"     IceFile         - Name of file containing ice input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
